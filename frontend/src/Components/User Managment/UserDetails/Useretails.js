...
function EmployeDetails() {
  ...
  const handleGenerateReport = async () => {
    ...
    doc.setFillColor(61, 141, 122); //Blue background color
    ...
    doc.setTextColor(3, 37, 44); // White text color for SSMS
    doc.setFontSize(16);
    doc.text("Secure Guard System - SGS", doc.internal.pageSize.getWidth() - 95, 9); // Positioning for SSMS title
    
    doc.setFontSize(12);
    doc.text("Address: No 50/B, Galle Road, Colombo", doc.internal.pageSize.getWidth() - 95, 15); // Positioning for Address


    doc.setFontSize(12);
    doc.text("Contact No: +94 71 560 7832", doc.internal.pageSize.getWidth() - 95, 21); // Positioning for Contact No

    doc.setFontSize(12);
    doc.text("Email: sgs@info.com", doc.internal.pageSize.getWidth() - 95, 26); // Positioning for Contact No
    ...
    doc.setFillColor(61, 141, 122);// Blue background for footer
